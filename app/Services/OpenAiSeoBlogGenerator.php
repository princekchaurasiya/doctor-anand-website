...
final class OpenAiSeoBlogGenerator
{
    ...
    public static function generate(array $post): string
    {
        ...
        $focusKeyword = $post['focus_keyword'] ?? 'surgical care Mumbai';
        ...
        try {
            $response = OpenAI::chat()->create([
                ...
                'messages' => [
                    [
                        'role' => 'system',
                        'content' => 'You are an expert medical SEO writer for Satatva Health in Mumbai. Output ONLY valid HTML. No markdown fences. No preamble.',
                    ],
...
Generate a COMPLETE SEO-optimized blog article in VALID HTML for Satatva Health (surgical care, proctology, general surgery, Satatv Clinic Kandivali West, Mumbai).
...
3. Primary keyword "{$focusKeyword}" appears naturally in: <h1>, first <p> after <h1>, several <h2>, conclusion. Include semantic / LSI terms: general surgery, proctology, laser surgery, piles, fistula, Kandivali, Mumbai, Satatv Clinic.
...
5. Structure:
   <h1>{$title}</h1>
   <p>Strong SEO intro mentioning Mumbai and Satatva Health...</p>
   <h2>Overview</h2> ...
   <h2>Key benefits</h2> <ul>...</ul>
   <h2>When to seek care</h2> <h3>...</h3> ...
   <h2>Practical guidance</h2> (include a <table> comparing treatment options when relevant)
   ...
   <h2>Conclusion</h2>
   <div class="cta-section"><p>Call Satatva Health for a consultation in Mumbai: mention phone +91 8286214707 and <a href="/contact">request an appointment</a>.</p></div>
...
Brand: Satatva Health
Location: Satatv Clinic, Kandivali West, Mumbai
